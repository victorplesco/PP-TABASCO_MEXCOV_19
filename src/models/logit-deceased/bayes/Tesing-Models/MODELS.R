...
train.set <- swabspos[ind,]; test.set  <- swabspos[-ind,];  
...
# saveRDS(tstudent.stan.glm.model.8x2000.rds, "~/TABASCO-MEXCOV-19/src/models/logit-deceased/bayes/Tesing-Models/tstudent.stan.glm.model.8x2000.rds"); rm(tstudent.stan.glm.model.8x2000.rds);
tstudent.stan.glm.model.8x2000 <-  readRDS("~/TABASCO-MEXCOV-19/src/models/logit-deceased/bayes/Tesing-Models/tstudent.stan.glm.model.8x2000.rds");
