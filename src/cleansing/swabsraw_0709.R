...
mex <- read.csv(unzip("~/TABASCO-MEXCOV-19/data/original/0709/datos_abiertos_covid19.zip"));
# str(mex);
...
# [NEW VALUE]: SUSCEPTIBLE <> OTRO_CASO = Yes {1}, No {2}, NA {else};
...
write.csv(swabsraw, file = gzfile("~/TABASCO-MEXCOV-19/data/cleansed/0709/swabsraw_0709.csv.gz"), row.names = FALSE);